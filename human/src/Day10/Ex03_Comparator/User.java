...
public class User implements Comparator<User> {
	...
	public int compare(User o1, User o2) {
		...
		// 음수 리턴 시, o1 이 더 앞에 나온다.
		// "o1.age 이 o2.age 보다 더 작은 데이터야"
		...
		if( o1.age == o2.age ) {
			...
			if( o1.name.compareTo( o2.name ) < 0 ) {
				return -1;		// o1.name 이 o2.name 보다 작다 (김휴먼이 더 작다) --> 오름차순
			}
			
			// o1.name : 김휴먼
			// o2.name : 황휴먼
			if( o1.name.compareTo( o2.name ) > 0 ) {
				return 1;		// o1.name 이 o2.name 보다 크다 (김휴먼이 더 작다) --> 내림차순
			}
		}
